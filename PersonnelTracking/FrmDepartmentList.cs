...
namespace PersonnelTracking
{
    public partial class FrmDepartmentList : Form
    {
        ...
        {
            if (detail.ID == 0)
                MessageBox.Show("Please slect a department from table");
            else
            {
                FrmDepartment frm = new FrmDepartment();
                frm.isUpdate = true;
        ...
        {
            DialogResult result = MessageBox.Show("Are you sure you want to delete Department?", "warning", MessageBoxButtons.YesNo);
